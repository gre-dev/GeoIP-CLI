...
const LookupHelp = () => {
    return (
        <>
            ...
            <Box>
                <Text>      geoip {`lookup <ip-address> [options...]`}</Text>
            </Box>
            <Text> </Text>
            ...
            <Box><Text>      geoip lookup 1.1.1.1 -i</Text></Box>
            <Box><Text>      geoip lookup 1.1.1.1 -i -o JSON</Text></Box>
            <Box><Text>      geoip lookup 1.1.1.1 -i -o JSON -d</Text></Box>
            <Box><Text>      geoip lookup 1.1.1.1 -i -m location,timezone,security</Text></Box>
            <Text> </Text>
            <Text> </Text>
        </>
    )
