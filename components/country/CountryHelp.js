...
const CountryHelp = () => {
    return (
        <>
            ...
            <Box>
                <Text>      ggip {`country <country-code> [options...]`}</Text>
            </Box>
            <Text> </Text>
            ...
            <Box><Text>      ggip country US -i</Text></Box>
            <Box><Text>      ggip country US -i -o JSON</Text></Box>
            <Box><Text>      ggip country US -i -o JSON -d</Text></Box>
            <Box><Text>      ggip country US -i -m language,flag,currency,timezone</Text></Box>
            <Text> </Text>
            <Text> </Text>
        </>
    )
